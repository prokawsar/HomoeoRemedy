...
!function (t, e, a, i) {
    ...
    var r = {
        ...
        currencySettings: {
            locales: "en-US",
            currencyOptions: {style: "currency", currency: "BDT", currencyDisplay: "symbol"}
        },
        toolbarSettings: {
            showToolbar: !0,
    ...
    t.extend(s.prototype, {
        init: function () {
            ...
            var e = t("<div></div>").addClass("panel-footer sc-toolbar"), a = t('<div class="sc-cart-toolbar">'),
            ...
            var i = this, s = this._getValidateNumber(a);
            ...
            var a = (e[this.options.paramSettings.productQuantity] - 0) * (e[this.options.paramSettings.productPrice] - 0),
                i = t(".sc-cart-item-list", this.cart_element), s = i.find("[data-unique-key='" + e.unique_key + "']");
            if (s && s.length > 0) s.find(".sc-cart-item-qty").val(e[this.options.paramSettings.productQuantity]), s.find(".sc-cart-item-amount").text(this._getMoneyFormatted(a)); else {
            ...
            switch (this.options.submitSettings.submitType) {
                case "ajax":
                    var i = this.options.submitSettings.ajaxURL && this.options.submitSettings.ajaxURL.length > 0 ? this.options.submitSettings.ajaxURL : a.attr("action"),
                        s = t.extend(!0, {}, {
                            url: i, type: "POST", data: a.serialize(), beforeSend: function () {
